...
OBJS_TEST_TARGET1 = deps\swap\swap.o \
	...
	lib\ui\ui_draw_number.o lib\ui\ui_draw_board.o lib\ui\ui_draw_all_board.o lib\ui\ui_draw_circle.o lib\ui\ui_draw_board_circle.o\
	lib\cmb\c_bingo_circle.o\
       test\$(TEST_NAME).o
